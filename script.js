document.addEventListener('DOMContentLoaded', function (){
    ...
    confirmPasswordInput.addEventListener('change', function(event){
        clearError(confirmPaswordError)
    })
    ...
    function validateEmail(){
        ...
        const emailValue = emailInput.value.trim() // el trim lo que hace es eliminar espacio al comienzo y final del input
    ...
    function validatePasswordMatch(){
        ...
        if(passwordValue != confirmPasswordValue){
            showError(confirmPaswordError, 'Las contraseñas no coinciden')
            return false;
        }
